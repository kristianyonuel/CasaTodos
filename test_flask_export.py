...
# Simple test of the exact export function issue
import os
import sys
...
def test_export_with_flask_context():
    """Test export function within Flask application context"""
    ...
    with app.app_context():
        ...
        with app.test_request_context():
            ...
            try:
                # Test the exact database pattern from export function
                week = 1
                year = 2025
                user_id = session['user_id']
                username = session['username']
                
                print(f"Testing export for user {username}, Week {week}, {year}")
                ...
                with get_db() as conn:
                    ...
                    # Test CSV generation (this is where it might fail)
                    output = io.StringIO()
                    ...
                    # Important: Access csv_content while still in database context
...
if __name__ == "__main__":
    success = test_export_with_flask_context()
